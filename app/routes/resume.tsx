...
export const meta = () => [
  ...
  { name: "description", content: "Deatiled overview or your resume" },
];
    ...
    <main className="!pt-0">
      ...
      <div className="flex flex-row w-full max-lg:flex-col-reverse">
        <section className="feedback-section bg-[url('/images/bg-small.svg')] bg-cover h-[100vh] sticky top-0 items-center justify-center">
          {imageUrl && resumeUrl && (
            <div className="animate-in fade-in duration-100 gradient-border max-sml:m-0 h-[90%] max-wxl:h-fit w-fit">
